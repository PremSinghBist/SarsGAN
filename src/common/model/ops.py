...
def slerp(val, low, high):
    """
    Spherical linear interpolation :  Returns interpoloated vector based on low and high vector with val factor
    Args:
        val: interpolation factor 
        low: lowest value
        high: highest value

    Returns: Interpolated vector on the unit sphere 
