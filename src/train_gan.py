...
def main(_, is_test=False, debug_cli=False, debug_ui=False):
    ...
    with graph.as_default():
        ...
        noise = tf.random.truncated_normal([FLAGS.batch_size, NOISE_INITIAL_DIMENSION], stddev=0.5, dtype=tf.float32, name='noise')
        ...
        #Use Precomputed embedding values or Not : True default
        ...
        #g_step: 1 | d_step: 1
        #Determine how many times each network is updated within a single training iteration.
