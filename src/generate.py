...
flags.DEFINE_boolean('blast', True, 'Flags to determine whether to add blast results')
FLAGS = get_flags()
...
def generate_sequences():
    ...
    #Overriding batchsize value for generation
    FLAGS.batch_size = 16000 #12000 #8000   #4000 # ##  
    ...
    if FLAGS.blast:
        db_path = FLAGS.blast_db #os.path.join(FLAGS.data_dir, FLAGS.dataset,FLAGS.blast_db.replace("\\", os.sep) + "_" + FLAGS.running_mode)
