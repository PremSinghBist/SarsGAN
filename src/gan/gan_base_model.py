...
class GAN(object):
    def __init__(self, data_handler, noise):
        ...
        self.noise = noise
        #self is here point to SNGAN object, so SNGAN.get_discriminator_and_generator() is called
    ...
    def build_model_single_gpu(self, batch_size=1):
        ...
        #self represents instance of SNGAN/ or this same class 
        ...
        #identity returns the same tensor but just provide the name 
    ...
    def get_generated_data(self, data, labels):
        #calls to ResNetGenerator.generate
        # (As ResNetGenerator does not have generate method calls parent class Genertor.generate method)
        #data means noise 
