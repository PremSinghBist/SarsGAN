...
class SNGAN(GAN):
    ...
    def get_loss(self, real_x, fake_x, gen_sparse_class, discriminator_real, discriminator_fake, r_h, f_h):
        if self.config.loss_type == 'hinge_loss_std':
            ...
            #discriminator_fake : discriminator output for fake seqs 
            ...
            #d_loss_real += r1_penalty * (10 * 0.5) #@original
            #d_loss_real += r1_penalty * (2 * 0.5) #@modified #Reduce it by 5 times and check
            d_loss_real += r1_penalty #Without penalty multiplied 
