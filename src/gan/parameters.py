...
#No of steps to train : 1 step means number of sequences considered in one batch
flags.DEFINE_integer('steps', 2500000, 'Number of steps to train') #default 2.5 million
...
flags.DEFINE_string('weights_dir', "/home/perm/ProteinGAN/data/weights",
                    'Location where all weights should be saved')
flags.DEFINE_string('data_dir', "/home/perm/ProteinGAN/data/protein/Length_512_lab_test_37_v2",
                    'Location where all data is stored')

flags.DEFINE_string('generate_dir', "/home/perm/ProteinGAN/data/log/gen", 'Log directory where model weights, generated file saved')
...
if MODEL_TYPE == 'sngan':
    ...
    flags.DEFINE_integer('gf_dim', 128, 'Dimensionality of gf. [64]') #48 
    flags.DEFINE_integer('df_dim', 128, 'Dimensionality of df. [64]') #36
...
if DATASET == 'image':
    ...
    flags.DEFINE_string('blast_db', '/home/perm/ProteinGAN/data/cov_seqs/sars_db/cov_blast', 'Location where fasta db is stored')
