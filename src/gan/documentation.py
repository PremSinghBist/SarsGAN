...
def get_model_overview(model_directory):
    ...
    with open("/home/perm/ProteinGAN/README.md", 'r') as f:
        overview = f.read()
    return overview
...
def get_properties(flags):
    path = "/home/perm/ProteinGAN/data/properties.json" 
    #os.path.join(flags.data_dir, flags.dataset.replace("\\", os.sep), flags.properties_file)
...
def setup_logdir(flags, properties):
    return "/home/perm/ProteinGAN/data/log"
